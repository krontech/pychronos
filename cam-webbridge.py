...
def main():
    ...
    Method(control, controlApi, 'startBlackCalibration',  arguments=False)
    Method(control, controlApi, 'startZeroTimeBlackCal',  arguments=False)
    Method(control, controlApi, 'startAnalogCalibration', arguments=False)
